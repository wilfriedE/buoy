...
3. **Web portal** – Open a browser and go to `http://buoy.buoy` (or the IP shown after connecting). You'll see the dashboard with connected devices and a link to the ROS topic graph.
